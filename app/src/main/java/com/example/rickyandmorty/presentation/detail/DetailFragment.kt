...
import com.example.rickyandmorty.databinding.FragmentDetailBinding
...
import com.example.rickyandmorty.utility.FEMALE
import com.example.rickyandmorty.utility.MALE
...
//    }
    ...
    private fun handleSuccessDetailUiState(characterUiData: CharacterUiData?) {
        if (characterUiData != null) {
            ...
            binding.characterLocation.text = characterUiData.location?.name
